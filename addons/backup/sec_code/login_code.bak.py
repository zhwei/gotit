...
#    keepalive_handler,
#    urllib2.HTTPHandler(),
#    urllib2.HTTPSHandler(),FIELDNAME = models.AutoField()
...
uuu = 'http://210.44.176.132/xskbcx.aspx?xh=1111051046&xm=%D5%C5%CE%C0&gnmkdm=N121603'
req2 = urllib2.Request(url=uuu,headers=headers)
b = opener.open(req2).read().decode('gbk')
print b
